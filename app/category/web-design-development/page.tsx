...
export default function WebDesignDevelopmentPage() {
  ...
  useEffect(() => {
    const loadProjects = async () => {
      try {
        const data = await projectsAPI.getAll("web-design-development")
        setProjects(data)
      } catch (error) {
        ...
        <div className="grid h-full grid-cols-1 gap-4 lg:grid-cols-[420px_1fr]">
            ...
            >
              ...
              <div>
                ...
                <AnimatedHeading
                  ...
                  lines={["Web Design &", "Development"]}
                />

                <p className="mt-4 max-w-[42ch] text-lg text-neutral-600">
                  Custom websites and web applications built with modern technologies. We create digital experiences
          ...
          <div className="space-y-4">
            {loading ? (
              ...
              <div className="flex items-center justify-center py-20">
                <p className="text-neutral-600">No web design & development projects available yet.</p>
              </div>
            ) : (
              projects.map((p, idx) => (
                <ProjectCard
