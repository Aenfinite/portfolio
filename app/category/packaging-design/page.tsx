...
export default function PackagingDesignPage() {
  ...
  useEffect(() => {
    const loadProjects = async () => {
      try {
        const data = await projectsAPI.getAll("packaging-design")
        setProjects(data)
      } catch (error) {
        ...
        <div className="grid h-full grid-cols-1 gap-4 lg:grid-cols-[420px_1fr]">
            ...
            >
              ...
              <div>
                ...
                <p className="mt-4 max-w-[42ch] text-lg text-neutral-600">
                  Product packaging that stands out on shelves and creates memorable unboxing experiences. We design
                  packaging that protects, sells, and delights.
                </p>
          ...
          <div className="space-y-4">
            {loading ? (
              ...
              <div className="flex items-center justify-center py-20">
                <p className="text-neutral-600">No packaging design projects available yet.</p>
              </div>
            ) : (
              projects.map((p, idx) => (
                <ProjectCard
