...
export default function LogoDesignPage() {
  ...
  useEffect(() => {
    const loadProjects = async () => {
      try {
        const data = await projectsAPI.getAll("logo-design")
        setProjects(data)
      } catch (error) {
        ...
        <div className="grid h-full grid-cols-1 gap-4 lg:grid-cols-[420px_1fr]">
            ...
            >
              ...
              <div>
                ...
                <p className="mt-4 max-w-[42ch] text-lg text-neutral-600">
                  Memorable logos that define your brand identity and leave lasting impressions. We create distinctive
                  marks that resonate with your audience.
                </p>
          ...
          <div className="space-y-4">
            {loading ? (
              ...
              <div className="flex items-center justify-center py-20">
                <p className="text-neutral-600">No logo design projects available yet.</p>
              </div>
            ) : (
              projects.map((p, idx) => (
                <ProjectCard
