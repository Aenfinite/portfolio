...
export default function MobileAppPage() {
  ...
  useEffect(() => {
    const loadProjects = async () => {
      try {
        const data = await projectsAPI.getAll("mobile-app")
        setProjects(data)
      } catch (error) {
        ...
        <div className="grid h-full grid-cols-1 gap-4 lg:grid-cols-[420px_1fr]">
            ...
            >
              ...
              <div>
                ...
                <p className="mt-4 max-w-[42ch] text-lg text-neutral-600">
                  Native and cross-platform mobile applications for iOS and Android. We create engaging mobile
          ...
          <div className="space-y-4">
            {loading ? (
              ...
              <div className="flex items-center justify-center py-20">
                <p className="text-neutral-600">No mobile app projects available yet.</p>
              </div>
            ) : (
              projects.map((p, idx) => (
                <ProjectCard
