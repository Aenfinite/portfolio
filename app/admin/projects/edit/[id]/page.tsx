...
export default function EditProjectPage() {
  ...
  const loadProject = async () => {
    try {
      ...
      setFormData({
        ...
        gradientFrom: project.gradientFrom || "#e0e7ff",
        gradientTo: project.gradientTo || "#c7d2fe",
        priority: project.priority || false,
        category: project.category || "web-design-development",
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await projectsAPI.update(projectId, cleanedData)
