        ...
        <div className="relative overflow-hidden rounded-[1.35rem] bg-white lg:h-full">
          ...
          <div className="pointer-events-none absolute left-4 top-4 flex flex-wrap gap-2">
            {tags.map((t) => (
              <Badge
                key={t}
                variant="secondary"
                className="pointer-events-auto bg-white/90 text-neutral-900 border-neutral-200 backdrop-blur-sm"
              >
                {t}
              </Badge>
            ))}
          ...
          <div className="absolute inset-x-0 bottom-0 p-4 sm:p-5">
            <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
              ...
              <button
                onClick={onClick}
                className="inline-flex items-center gap-2 rounded-full bg-white/90 text-neutral-900 px-3 py-2 text-sm font-medium backdrop-blur transition-colors hover:bg-white self-start sm:self-auto"
